#!/usr/bin/env python3
"""
Kanban demo server — replaces `python3 -m http.server 8000`
Adds a /profiles/ API so the browser can save and load named config profiles.
...
class KanbanHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        # Strip trailing slash and query string for routing
    ...
    def end_headers(self):
        # Prevent browser from caching static files so data.json is always re-fetched
